...
import type { TaskEmits, TaskProps } from "@/tasks/types";
import type {
  SCOption,
  SCEvaluation,
  SCFeedback,
...
import { formatOptions } from "@/tasks/single-choice/options";
import { formatContent } from "@/tasks/single-choice/content";
import { formatTaskState } from "@/tasks/single-choice/state";
import { formatFeedbacks } from "@/tasks/single-choice/feedbacks";
import { formatEvaluation, evaluationOptions } from "@/tasks/single-choice/evaluation";
