  ...
  <TaskScaffold contenteditable="false" :editor="editor">
    ...
    <template #render>
      ...
      <span v-if="options?.showPartiallyCorrectCount && ['incorrect'].includes(state.state)"
        ...
        {{
          $t("editor.task.multiple-choice.label-partially-correct-count", numberCorrectlySelectedOptionsFromPreviousSubmit, {
            n: numberCorrectlySelectedOptionsFromPreviousSubmit,
          })
        }}
      </span>
    </template>
